...
I built this application to demonstrate how to use the React framework to my team (all are backend developers). I used Python and Flask for the backend API. 
